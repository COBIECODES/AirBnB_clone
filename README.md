...
```bash
git clone https://github.com/COBIECODES/AirBnB_clone.git
```
...
## Authors
<details>
    <summary>Raymond Toritseju Nesiama</summary>
    <ul>
    <li><a href="https://www.github.com/raymondnes">Github</a></li>
    </ul>
</details>
<details>
    <summary>Ezeunara Chikadibia Felix </summary>
    <ul>
    <li><a href="https://www.github.com/COBIECODES">Github</a></li>
    </ul>
</details>
